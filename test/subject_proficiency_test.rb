...
require_relative '../lib/subject_proficiency_parser'
require 'csv'
...
include ParserSubjectProficiency
  ...
  def test_it_can_format_each_subject_line_into_a_hash
    ...
    [
      {
        :name=>"Colorado", :"all students"=>{"2011"=>{"math"=>"0.5573"}}
      },
      {
      ...
      {
        :name=>"ACADEMY 20", :"all students"=>{"2011"=>{"math"=>"0.68"}}
      },
      {
      ...
      {
        :name=>"ADAMS COUNTY 14", :"all students"=>{"2011"=>{"math"=>"0.32"}}
      },
      {
      ...
      {
        :name=>"ADAMS-ARAPAHOE 28J", :"all students"=>{"2011"=>{"math"=>"0.38"}}
      },
      {
