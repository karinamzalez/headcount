...
class EconomicFormatterTest < Minitest::Test
  ...
  def test_it_can_merge_the_poverty_data_by_dsitrcit
    ...
    [
      {
        :name=>"ACADEMY 20",
        :children_in_poverty=>{2007=>0.039, 2008=>0.04404}
      },
      {
        :name=>"ADAMS COUNTY 14",
        :children_in_poverty=>{2007=>0.247, 2008=>0.22533}
      },
      {
        :name=>"ADAMS-ARAPAHOE 28J",
        :children_in_poverty=>{2007=>0.238, 2008=>0.18582}
      }
    ]
    ...
    [
      {:name=>"Colorado",
       :free_or_reduced_price_lunch=>
        {2012=>{:total=>297167, :percentage=>0.344},
         2014=>{:percentage=>0.34346, :total=>305342}}},
      {:name=>"ACADEMY 20",
       :free_or_reduced_price_lunch=>
        {2014=>{:total=>2156, :percentage=>0.08772},
        2012=>{:percentage=>0.09027, :total=>2164}}},
      {:name=>"ADAMS COUNTY 14",
       :free_or_reduced_price_lunch=>
       {2012=>{:total=>5486, :percentage=>0.73147},
       2014=>{:percentage=>0.65322, :total=>4954}}}
    ]
  ...
  def test_it_can_group_all_data_by_district_name
    ...
    {"Colorado"=>
      [
        ...
        {
          :name=>"Colorado",
          :free_or_reduced_price_lunch=>{2012=>{:total=>297167, :percentage=>0.344}, 2014=>{:percentage=>0.34346, :total=>305342}}
        },
        {
          :name=>"Colorado", :title_i=>{2013=>0.231, 2014=>0.235}
        }
      ...
      [
        ...
        {
          :name=>"ACADEMY 20",
          :free_or_reduced_price_lunch=>{2014=>{:total=>2156, :percentage=>0.08772}, 2012=>{:percentage=>0.09027, :total=>2164}}
        },
        {
          :name=>"ACADEMY 20", :children_in_poverty=>{2007=>0.039, 2008=>0.04404}
        },
        {
          :name=>"ACADEMY 20", :title_i=>{2013=>0.012, 2014=>0.027}
        }
      ...
      [
        ...
        {
          :name=>"ADAMS COUNTY 14",
          :free_or_reduced_price_lunch=>{2012=>{:total=>5486, :percentage=>0.73147}, 2014=>{:percentage=>0.65322, :total=>4954}}
        },
        {
          :name=>"ADAMS COUNTY 14",
          :children_in_poverty=>{2007=>0.247, 2008=>0.22533}
