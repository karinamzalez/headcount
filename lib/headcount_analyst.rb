class HeadcountAnalyst
  ...
  def kindergarten_participation_rate_variation(district1, district2)
    raw_variation =
    average_enrollment_kindergarten(district1)/average_enrollment_kindergarten(district2.values[0])
    raw_variation.to_s[0..4].to_f
  end

  def high_school_graduation_rate_variation(district1, district2)
    raw_variation =
    average_enrollment_high_school(district1)/average_enrollment_high_school(district2.values[0])
    raw_variation.to_s[0..4].to_f
  end
